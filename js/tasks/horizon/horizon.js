...
import { PsychoJS } from '/Horizon-Task/lib/core-2020.1.js';
import * as core from '/Horizon-Task/lib/core-2020.1.js';
import { TrialHandler } from '/Horizon-Task/lib/data-2020.1.js';
import { Scheduler } from '/Horizon-Task/lib/util-2020.1.js';
import * as util from '/Horizon-Task/lib/util-2020.1.js';
import * as visual from '/Horizon-Task/lib/visual-2020.1.js';
import { Sound } from '/Horizon-Task/lib/sound-2020.1.js';
...
window.onload = function () {
	...
	const getInfoPromise = new Promise((resolve, reject) => {
		$.ajax({
			type: 'GET',
			url: '/Horizon-Task/js/tasks/horizon/' + getQueryVariable('run'),
			dataType: 'json',
			success: (data) => {
				resolve(data)
			}
				...
				$.ajax({
					...
					success: (data) => {
						...
						for (var i=1; i<allRows.length; i++) {
							...
							out.push(obj);
							resources.push({ name: obj['instruct_slide'], path: '/Horizon-Task/' + obj['instruct_slide'] })
							resources.push({ name: obj['audio_path'], path: '/Horizon-Task/' + obj['audio_path'] })
						}
